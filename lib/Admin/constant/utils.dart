...
Widget CustomButton(String text, Function()? fun) => Container(
  constraints: const BoxConstraints(maxWidth: 250.0, minHeight: 50.0),
  margin: const EdgeInsets.all(10),
  child: ElevatedButton(
    onPressed: fun,
    style: ElevatedButton.styleFrom(
      backgroundColor: Colors.yellow, // Changer la couleur du bouton au jaune
    ),
    child: Padding(
...
Widget CustomAnimatedContainer(text, fun) => Padding(
      ...
      child: HoverCrossFadeWidget(
        ...
        secondChild: Container(
          ...
          decoration: BoxDecoration(
              color: Colors.white,
              border: Border.all(color: Color(0xFFEEC705), width: 2),
